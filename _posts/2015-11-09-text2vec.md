...
- Now text2vec uses regular exressions engine from `stringr` package (which is built on top of `stringi`). Now `regexp_tokenizer` much is more fast and robust.
...
{% highlight text %}
## Time difference of 3.987079 secs
{% endhighlight %}
...
{% highlight text %}
## Time difference of 44.57128 secs
{% endhighlight %}
...
{% highlight text %}
## Time difference of 20.13441 secs
{% endhighlight %}
...
{% highlight text %}
## Time difference of 23.92558 secs
{% endhighlight %}
...
{% highlight text %}
## Time difference of 36.05649 secs
{% endhighlight %}
...
{% highlight text %}
## Time difference of 26.24242 secs
{% endhighlight %}
...
{% highlight text %}
## Time difference of 13.09422 secs
{% endhighlight %}
...
{% highlight text %}
## Time difference of 60.67092 secs
{% endhighlight %}
